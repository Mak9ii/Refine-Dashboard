...
import DashboardTotalCountCards from "./home/total-count-cards";
...
export { UpcomingEvents, DealsChart, UpcomingEventsSkeleton, AccordionHeaderSkeleton, 
    KanbanColumnSkeleton, ProjectCardSkeleton, LatestActivitiesSkeleton, DashboardTotalCountCards ,LatestActivities };
